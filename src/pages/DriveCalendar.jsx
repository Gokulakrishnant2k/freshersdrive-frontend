...
const ltt = {
  ...
  searchInput:{ width:"100%", padding:"8px 12px 8px 32px", border:"1px solid #e2e8f0", borderRadius:"10px", fontSize:"13.5px", fontFamily:font, background:"#f8fafc", color:"#0f172a", outline:"none", boxSizing:"border-box", colorScheme:"light" },
...
const dm = {
  ...
  searchInput: { ...ltt.searchInput, background:"rgba(255,255,255,0.05)", borderColor:"rgba(255,255,255,0.14)", color:"#f1f5f9", colorScheme:"dark" },
